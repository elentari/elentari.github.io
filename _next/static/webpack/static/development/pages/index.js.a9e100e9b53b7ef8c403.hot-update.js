...
function IndexPage() {
  return __jsx(_components_PageLayout__WEBPACK_IMPORTED_MODULE_4__["PageLayout"], {
    ...
    onCreated: function onCreated(_ref) {
      var gl = _ref.gl;
      return gl.shadowMap.enabled = true, gl.shadowMap.type = three__WEBPACK_IMPORTED_MODULE_0__["PCFSoftShadowMap"], {
        /* (gl.gammaFactor = 2.2),
        (gl.gammaOutput = true),
        (gl.antialias = true) */
      };
...
//# sourceMappingURL=index.js.a9e100e9b53b7ef8c403.hot-update.js.map